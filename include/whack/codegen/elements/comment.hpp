...
class Comment final : public AST {
public:
  explicit constexpr Comment(const mpc_ast_t* const ast) : ast_{ast} {}
  inline llvm::Error codegen(llvm::Module* const) const noexcept {
...
class CommentStmt final : public stmts::Stmt {
public:
